---
title: Github 使用方法列表，从入门到精(fang)通(qi)
date: 2017-03-16 10:31:12
tags: github
---
# Github 使用方法列表，从入门到精(fang)通(qi)

部分网页可能需要科学爬墙才能看，需要梯子的同学可以看一下我的 [Centos环境下搭建 Shadowsocks 服务端翻墙](http://rekkles.xyz/2017/03/13/shadowsocks-config/)教程

# 新手看这里 [最浅显易懂的Git入门教程](http://www.liaoxuefeng.com/wiki/0013739516305929606dd18361248578c67b8067c8c017b000)
